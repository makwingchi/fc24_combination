...
@runtime
def create_each_club_constraint(df, model, player, map_idx, players_grouped, num_cnts):
...
def SBC(df):
    ...
    model = create_each_club_constraint(df, model, player, map_idx, players_grouped, num_cnts)
    '''Club'''
